...
function åldersKoll() {
   ...
   console.log(ålder);
    ...
    if (ålder >= 18) {
        /* Skriv ut svaret */
        elementOutput.value = "Du blir myndig, du får gifta dig, du får rösta, du får köpa cigaretter, du får köpa alkohol på restaurang och öl i affärer och du får ta körkort.";
    }
