/* Välj slumpat ord, ta in svaret, stäng spelet om det behövs, kolla om det är rätt bokstav och slutför allt när det är klart */
...
eKnapp.addEventListener("click", function() {
    ...
    if (fel == 10) {
        ...
        ctx.fillStyle("Game Over!", 100, 100);
    }
